...
public class ChronoCell {
    ...
    public static void main(String[] args) {
        ...
        /// Phase G1
            ///// Initial conditions
                sol.theta[0]= Operators.createFunction(Numbers.CGN(0.0),Numbers.CGN(support0),Numbers.CGN(step));
                Operators.MapFunctionValues(sol.theta[0],0.0,1.0,Operators.sinPeriodOne);
                ///// Transition
                sol.transitionProbabilities[0]=Operators.createFunction(Numbers.CGN(0.0),Numbers.CGN(support0),Numbers.CGN(0.01)); 
                Operators.MapFunctionValues(sol.transitionProbabilities[0],15.0,support0,Operators.continuousGeometricDistribution,15.0,pO2,C,B,M);
        ...
        /// Phase S
            ///// Initial conditions
                sol.theta[1]= Operators.createFunction(Numbers.CGN(0.0),Numbers.CGN(8.0),Numbers.CGN(step));
                Operators.MapFunctionValues(sol.theta[1],0.0,8.0,Operators.constant,0.0);
                ///// Transition
                sol.transitionProbabilities[1]=Operators.createFunction(Numbers.CGN(0.0),Numbers.CGN(8.0),Numbers.CGN(0.01)); 
                Operators.MapFunctionValues(sol.transitionProbabilities[1],7.99,8.0,Operators.constant,1.0);
        ...
        /// Phase G2
            ///// Initial conditions
                sol.theta[2]= Operators.createFunction(Numbers.CGN(0.0),Numbers.CGN(support2),Numbers.CGN(step));
                Operators.MapFunctionValues(sol.theta[2],0.0,support2,Operators.constant,0.0);
                ///// Transition
                sol.transitionProbabilities[2]=Operators.createFunction(Numbers.CGN(0.0),Numbers.CGN(support2),Numbers.CGN(0.01)); 
                Operators.MapFunctionValues(sol.transitionProbabilities[2],3.0,support2,Operators.continuousGeometricDistribution,3.0,pO2,C,B,M);
        ...
        /// Phase M
            ///// Initial conditions
                sol.theta[3]= Operators.createFunction(Numbers.CGN(0.0),Numbers.CGN(2.0),Numbers.CGN(step));
                Operators.MapFunctionValues(sol.theta[3],0.0,2.0,Operators.constant,0.0);
                ///// Transition
                sol.transitionProbabilities[3]=Operators.createFunction(Numbers.CGN(0.0),Numbers.CGN(2.0),Numbers.CGN(0.01)); 
                Operators.MapFunctionValues(sol.transitionProbabilities[3],1.99,2.0,Operators.constant,1.0);
...
//                for (int i=0;i<=0;i++){
//                    sol.theta[i]=Operators.MultiplyFunctions(sol.theta[1], Operators.PowerOfFunction(sol.oneMinusCumulativeFunctions[1], -1));
//                }
         // Simulation
        
//         Display Function
//        GUI win1 =new GUI();    
//        win1.SetFunction(sol.oneMinusCumulativeFunctions[0]);
//        win1.setVisible(true);
//        Operators.PrintFunction("1-F", sol.oneMinusCumulativeFunctions[0]);
//        GUI win2 =new GUI();
